...
- Пополнить баланс кошелька на Devnet (либо дождаться сброса лимита через 8 часов, либо использовать другой кошелёк).
- Выполнить минт через фронтенд на Devnet, скопировать сигнатуру транзакции.
- Добавить ссылку на транзакцию в `README.md` и сделать финальный коммит.