...
const ORACLE_PROGRAM_ID = new PublicKey("C4dYoNH7B2gGTAkCTdbFbviQRSjEYp6ZHAD7dhNZixR5");
const MINTER_PROGRAM_ID = new PublicKey("83VyNBbwTJnVWKJQWhf8GzrsyzNgZ4RDwjrTQREv34UH");
